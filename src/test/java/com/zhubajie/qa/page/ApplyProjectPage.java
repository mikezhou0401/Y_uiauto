...
public class ApplyProjectPage extends Page {
    ...
    public void inputDepartment(){
        ...
        this.getElement("部门ID").sendKeys(departmentId);
        DateUtil.sleep(3);
        this.removeAttribute("department");
        this.getElement("部门").sendKeys(department);
    }
    /**
     * 项目名称
     */
    public void inputProjectName(){
        this.getElement("语言").click();
        this.getElement("主业务").click();
        this.getElement("项目名称").sendKeys(projectName + current);
        System.out.println(projectName + current);
        this.getElement("类型").click();
    }
    ...
    public void inputZhName(){
        this.getElement("中文名称").sendKeys(zhName);
    }
    ...
    public void inputMavenGroupId(){
        this.getElement("Maven_Group_Id").sendKeys(Maven_Group_Id);
    }
    ...
    public void inputProjectGITGroupName(){
        this.getElement("PROJECT_GIT_GROUP_NAME").sendKeys(PROJECT_GIT_GROUP_NAME);
    }
    ...
    public void inputProjectPhpGroupName(){
        this.getElement("PHP_GIT_GROUP_NAME").sendKeys(PHP_GIT_GROUP_NAME);
    }
    ...
    public void inputProjectNodeJsGroupName(){
        this.getElement("NODEJS_GIT_GROUP_NAME").sendKeys(NODEJS_GIT_GROUP_NAME);
    }
    ...
    public void inputEngineName(){
        this.getElement("系统名称").sendKeys(projectName + current);
        System.out.println(projectName + current);
    }
     ...
     */
    public void confirm(){
        this.getElement("确认申请").click();
        DateUtil.sleep(2);
        this.getElement("再次确认申请").click();
        DateUtil.sleep(2);
